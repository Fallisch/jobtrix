      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="appearance-none w-3 h-3 border border-gray-400 dark:border-gray-500 rounded-sm cursor-pointer shrink-0 checked:bg-accent checked:border-accent relative after:content-[''] after:absolute after:left-[3px] after:top-[0.5px] after:w-[4px] after:h-[7px] after:border-white after:border-r-[1.5px] after:border-b-[1.5px] after:rotate-45 after:opacity-0 checked:after:opacity-100"
          />
