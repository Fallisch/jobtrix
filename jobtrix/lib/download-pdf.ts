...
export async function downloadCoverLetterPdf(coverLetter: string, profile: ProfileData, template: "classic" | "modern" | "traditional" | "accent" = "classic", accentColor?: string) {
...
export async function downloadCvPdf(cv: string, profile: ProfileData, template: "classic" | "modern" | "traditional" | "accent" = "classic", cvStyle: "classic" | "american" = "classic", accentColor?: string) {
  await triggerDownload(
